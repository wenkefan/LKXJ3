...
import com.fwk.lkxj3.common.util.ConstUtils.*;

import static com.fwk.lkxj3.common.util.ConstUtils.DAY;
import static com.fwk.lkxj3.common.util.ConstUtils.HOUR;
import static com.fwk.lkxj3.common.util.ConstUtils.MIN;
import static com.fwk.lkxj3.common.util.ConstUtils.MSEC;
import static com.fwk.lkxj3.common.util.ConstUtils.SEC;
...
public class TimeUtils {
    ...
    public static final SimpleDateFormat yyyyTdd = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss",Locale.getDefault());
    /**
     * 将时间戳转为时间字符串
    ...
    public static String getyyyy_MM_ddString(){
        ...
        return milliseconds2String(getCurTimeMills(), yyyy_MM_dd);
    }
    public static String getyyThh(){
        return milliseconds2String(getCurTimeMills(), yyyyTdd);
    }
    /**
     * 将时间戳转为时间字符串
     * <p>格式为用户自定义</p>
