...
public class SelectJCObjTeacherAdapter extends BaseAdapter {
    private Context mContext;
    private List<WorkerExtensionBean.RerurnValueBean> mList;
    private int selectItem = -1;
    public SelectJCObjTeacherAdapter(Context mContext, List<WorkerExtensionBean.RerurnValueBean> mList){
